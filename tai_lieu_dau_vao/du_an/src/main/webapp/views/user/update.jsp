...
<div class="container update-form">
    ...
    <head>
        ...
        <style>
            ...
            .update-form { max-width: 500px; margin: 50px auto; }
    ...
    <div class="container update-form">
        ...
        <div class="card-body">
            <h4 class="card-title text-center mb-4">Cập nhật thông tin khách hàng</h4>
            ...
            <form action="/update" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="citizenNumber" class="form-control" value="${customer.citizenNumber}" required>
                </div>

                <div class="mb-3">
                    <label class="form-label">Số điện thoại</label>
                    <input type="text" name="phoneNumber" class="form-control" value="${customer.phoneNumber}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="password-wrapper">
                        <input id="password" type="password" name="password" class="form-control" value="${account.passwordHash}">
