...
VALUES ('khach1', 'pass1', 'KHACH_HANG'),
       ('khach2', 'pass2', 'KHACH_HANG'),
       ('khach3', 'pass3', 'KHACH_HANG'),
       ('khach4', 'pass4', 'KHACH_HANG'),
       ('khach5', 'pass5', 'KHACH_HANG'),
       ('khach6', 'pass6', 'KHACH_HANG'),
       ('khach7', 'pass7', 'KHACH_HANG'),
       ('khach8', 'pass8', 'KHACH_HANG'),
       ('khach9', 'pass9', 'KHACH_HANG'),
       ('khach10', 'pass10', 'KHACH_HANG'),
       ('khach11', 'pass11', 'KHACH_HANG'),
       ('khach12', 'pass12', 'KHACH_HANG'),
       ('khach13', 'pass13', 'KHACH_HANG'),
       ('khach14', 'pass14', 'KHACH_HANG'),
       ('khach15', 'pass15', 'KHACH_HANG'),
       ('nv1', 'passnv1', 'NHAN_VIEN'),
       ('nv2', 'passnv2', 'NHAN_VIEN'),
       ('nv3', 'passnv3', 'NHAN_VIEN'),
       ('nv4', 'passnv4', 'NHAN_VIEN'),
       ('nv5', 'passnv5', 'NHAN_VIEN');

-- ==========================
-- 2. Employee (5 nhân viên)
-- ==========================
INSERT INTO employee (account_id, full_name, dob, phone_number, salary, email, cccd)
VALUES (16, 'Nguyen Van A', '1995-05-10', '0901111111', 12000000, 'nva@pawnshop.com', '012345678901'),
       (17, 'Tran Thi B', '1998-07-22', '0902222222', 10000000, 'ttb@pawnshop.com', '012345678902'),
       (18, 'Le Van C', '1990-01-15', '0903333333', 15000000, 'lvc@pawnshop.com', '012345678903'),
       (19, 'Pham Thi D', '1992-03-12', '0904444444', 11000000, 'ptd@pawnshop.com', '012345678904'),
       (20, 'Hoang Van E', '1988-08-08', '0905555555', 13000000, 'hve@pawnshop.com', '012345678905');

-- ==========================
-- 3. Customer (15 khách hàng)
-- ==========================
INSERT INTO customer (account_id, full_name, cccd, phone_number, address, email, dob)
VALUES (1, 'Pham Van D', '111111111111', '0911111111', 'Ha Noi', 'c1@mail.com', '2000-03-12'),
       (2, 'Le Thi E', '222222222222', '0922222222', 'Hai Phong', 'c2@mail.com', '1999-10-05'),
       (3, 'Hoang Van F', '333333333333', '0933333333', 'Nam Dinh', 'c3@mail.com', '1997-01-21'),
       (4, 'Tran Thi G', '444444444444', '0944444444', 'Ha Nam', 'c4@mail.com', '1996-07-15'),
       (5, 'Nguyen Van H', '555555555555', '0955555555', 'Hai Duong', 'c5@mail.com', '2001-11-30'),
       (6, 'Do Thi I', '666666666666', '0966666666', 'Ha Noi', 'c6@mail.com', '2002-06-18'),
       (7, 'Pham Van J', '777777777777', '0977777777', 'Thanh Hoa', 'c7@mail.com', '1995-12-25'),
       (8, 'Nguyen Thi K', '888888888888', '0988888888', 'Nghe An', 'c8@mail.com', '1998-04-10'),
       (9, 'Le Van L', '999999999999', '0912345678', 'Hai Phong', 'c9@mail.com', '1999-09-09'),
       (10, 'Tran Van M', '101010101010', '0923456789', 'Ha Noi', 'c10@mail.com', '2000-01-01'),
       (11, 'Pham Thi N', '111213141516', '0934567890', 'Nam Dinh', 'c11@mail.com', '1997-12-12'),
       (12, 'Hoang Van O', '121314151617', '0945678901', 'Ha Nam', 'c12@mail.com', '1996-06-06'),
       (13, 'Nguyen Van P', '131415161718', '0956789012', 'Hai Duong', 'c13@mail.com', '2001-03-03'),
       (14, 'Do Thi Q', '141516171819', '0967890123', 'Ha Noi', 'c14@mail.com', '2002-02-02'),
       (15, 'Pham Van R', '151617181920', '0978901234', 'Thanh Hoa', 'c15@mail.com', '1995-05-05');
...
VALUES (1, 1, 1, '2025-01-01', 15000000, 3.5, '2025-04-01', '2025-03-01'),
       ...
       (7, 2, 22, '2025-03-15', 20000000, 4.2, '2025-06-15', NULL),
       (8, 3, 23, '2025-03-18', 8000000, 3.8, '2025-06-18', '2025-04-20'),
       (9, 4, 24, '2025-03-20', 10000000, 3.5, '2025-06-20', NULL),
       (10, 5, 25, '2025-03-22', 12000000, 3.9, '2025-06-22', NULL),
       (11, 1, 26, '2025-03-25', 15000000, 4.0, '2025-06-25', '2025-05-28'),
       (12, 2, 27, '2025-03-28', 25000000, 4.5, '2025-06-28', NULL),
       (13, 3, 28, '2025-03-30', 22000000, 3.7, '2025-06-30', NULL),
       (14, 4, 29, '2025-04-01', 18000000, 3.8, '2025-07-01', NULL),
       (15, 5, 30, '2025-04-05', 20000000, 4.0, '2025-07-05', NULL);
...
VALUES (1, 4, NULL, '2025-04-10', 9500000),
       (2, 10, 2, '2025-04-12', 17000000),
       (3, 17, NULL, '2025-04-15', 21000000),
       (4, 5, 6, '2025-04-18', 12000000),
       (5, 9, NULL, '2025-04-20', 7500000),
       (1, 15, 3, '2025-04-22', 16000000),
       (2, 21, NULL, '2025-04-25', 9000000),
       (3, 24, 8, '2025-04-28', 10000000),
       (4, 28, NULL, '2025-04-30', 22000000),
       (5, 30, 12, '2025-05-01', 20000000),
       (1, 18, NULL, '2025-05-03', 13000000),
       (2, 20, 5, '2025-05-05', 18000000),
       (3, 26, NULL, '2025-05-07', 15000000),
       (4, 29, 7, '2025-05-10', 18000000),
       (5, 25, NULL, '2025-05-12', 12000000);
